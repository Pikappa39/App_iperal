...
$staticAssets = [
    ...
    './assets/js/pages/index-shell.js?v=' . $assetVersion,
    './assets/js/modules/auth/login.js?v=' . $assetVersion,
    './assets/js/modules/auth/password-reset-request.js?v=' . $assetVersion,
    './assets/js/modules/auth/password-reset-confirm.js?v=' . $assetVersion,
    './assets/js/modules/users/addetti.js?v=' . $assetVersion,
    './assets/js/modules/schedules/calendar.js?v=' . $assetVersion,
    './assets/js/modules/schedules/changes.js?v=' . $assetVersion,
    './assets/js/modules/schedules/department-overview.js?v=' . $assetVersion,
    './assets/js/modules/schedules/upload-page.js?v=' . $assetVersion,
    './assets/js/modules/notes/notes.js?v=' . $assetVersion,
    './assets/js/modules/holidays/common.js?v=' . $assetVersion,
    './assets/js/modules/holidays/department.js?v=' . $assetVersion,
    './assets/js/modules/holidays/personal.js?v=' . $assetVersion,
